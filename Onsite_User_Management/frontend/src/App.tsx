        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <Layout>
                  <Navigate to="/courses/onsite/planning" replace />
                </Layout>
              </PrivateRoute>
            }
          />
          {/* Onsite courses */}
          <Route
            path="/courses/onsite/planning"
            element={
              <PrivateRoute>
                <Layout>
                  <Courses courseType="onsite" status="planning" />
                </Layout>
              </PrivateRoute>
            }
          />
          <Route
            path="/courses/onsite/upcoming"
            element={
              <PrivateRoute>
                <Layout>
                  <Courses courseType="onsite" status="upcoming" />
                </Layout>
              </PrivateRoute>
            }
          />
          <Route
            path="/courses/onsite/ongoing"
            element={
              <PrivateRoute>
                <Layout>
                  <Courses courseType="onsite" status="ongoing" />
                </Layout>
              </PrivateRoute>
            }
          />
          <Route
            path="/courses/onsite/completed"
            element={
              <PrivateRoute>
                <Layout>
                  <Courses courseType="onsite" status="completed" />
                </Layout>
              </PrivateRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <Layout>
                  <Courses courseType="online" status="all" />
                </Layout>
              </PrivateRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <Layout>
                  <Navigate to="/courses/onsite/ongoing" replace />
                </Layout>
              </PrivateRoute>
            }
          />
          <Route
            ...
            element={
              <PrivateRoute>
                <Layout>
                  <Navigate to="/courses/onsite/completed" replace />
                </Layout>
              </PrivateRoute>
            }
          />
          <Route
            ...
            element={
              <PrivateRoute>
                <Layout>
                  <Navigate to="/courses/onsite/upcoming" replace />
                </Layout>
              </PrivateRoute>
            }
          />
