      ...
      <DialogContent>
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" gutterBottom>{mentor.name}</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" gutterBottom>{mentor.email || 'N/A'}</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" gutterBottom>{mentor.designation || 'N/A'}</Typography>
          </Grid>
              ...
              <Grid item xs={12} sx={{ mt: 3 }}>
                ...
                {loadingStats ? (
                  ...
                  <Box display="flex" flexDirection="column" gap={2}>
                    {mentorStats.per_course_stats.map((course: MentorCourseStats, index: number) => {
                          ...
                          <CardContent>
                            <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={1}>
                              ...
                              <Chip
                                ...
                                color={getCompletionColor(completionRatio)}
                                size="small"
                                sx={{ fontWeight: 600 }}
                              />
                            </Box>
                            ...
                            <Box display="flex" gap={3} mt={2} flexWrap="wrap">
                              ...
                              <Box>
                                ...
                                <Typography variant="body1" sx={{ fontWeight: 600, color: 'success.main' }}>
                                  tk {parseFloat(String(course.amount_paid || 0)).toFixed(2)}
                                </Typography>
                              </Box>
                              <Box>
                                <Typography variant="caption" color="text.secondary" display="block">
