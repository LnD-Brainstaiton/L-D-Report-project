...
function Reports() {
  ...
  const handleDownloadReport = async (reportType, courseId = null) => {
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Complete enrollment history for all active employees including course details, attendance, scores, and completion status.
              </Typography>
              <Button
                variant="contained"
                startIcon={<Download />}
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Generate individual reports for specific courses. Select a course below to download its enrollment report.
              </Typography>
