...
function CostBreakdownCard({
  ...
  const totalMentorCost = calculateTotalMentorCost(course, draftMentorsWithDetails);
  const totalTrainingCost = calculateTotalTrainingCost(course, draftMentorsWithDetails);
