 ...
 */
export const filterOnlineCourses = (courses, dateRange = null) => {
 ...
 */
export const filterOnsiteCourses = (courses, dateRange = null) => {
  const today = new Date();
  today.setHours(0, 0, 0, 0);
  ...
  const completed = courses.filter(c => getCourseStatus(c) === 'completed');
